...
-(UIColor *)getBarColorWithIndex:(int)index{
    return [[_data objectAtIndex:index-1] valueForKey:kHACColor] ? [[_data objectAtIndex:index-1] valueForKey:kHACColor] : [UIColor redColor];
}
...
-(void)createChart{
    ...
    for (int i = 1; i<=_data.count; i++) {
        ...
        UILabel *progressText = [self setLabelWithFrame:[self getFrameLabelWith:widthLine index:i progress:progress]
                                               ...
                                               barColor:barColor
                                               progress:progress];
        progressText.textAlignment = UITextAlignmentLeft;
        ...
        _vertical ? [[progressText layer] addAnimation:animationLabel forKey:@"x"] : [[progressText layer] addAnimation:animationLabel forKey:@"x"];
